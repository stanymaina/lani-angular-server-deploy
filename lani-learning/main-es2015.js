...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<app-header *ngIf=\"!router.url.includes('course')\"></app-header>\n  <router-outlet (activate)=\"onActivate($event)\">\n  </router-outlet>\n<app-footer *ngIf=\"!router.url.includes('course')\"></app-footer>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>course-detail-nav works!</p>\n");
...
/* harmony import */ var _shared_mainjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../shared/mainjs */ "./src/app/shared/mainjs.ts");
...
/* harmony import */ var _admissions_admissions_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./admissions/admissions.component */ "./src/app/admissions/admissions.component.ts");
/* harmony import */ var _course_detail_course_detail_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./course-detail/course-detail.component */ "./src/app/course-detail/course-detail.component.ts");
...
/* harmony import */ var _admissions_admissions_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./admissions/admissions.component */ "./src/app/admissions/admissions.component.ts");
...
/* harmony import */ var _course_detail_course_detail_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./course-detail/course-detail.component */ "./src/app/course-detail/course-detail.component.ts");
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _shared_courses__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../shared/courses */ "./src/app/shared/courses.ts");
...
let CourseDetailComponent = class CourseDetailComponent {
    ...
    getDimensionsByFilter(id) {
        return this.course_items.filter(x => x.id === id);
    }
    getDimensionsByFind(id) {
        return this.course_items.find(x => x.id === id);
    }
};
...
CourseDetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./course-detail.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/course-detail/course-detail.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./course-detail.component.css */ "./src/app/course-detail/course-detail.component.css")).default]
    })
...
let CoursesComponent = class CoursesComponent {
    constructor() {
        ...
        const course_items = _shared_courses__WEBPACK_IMPORTED_MODULE_3__["courses"];
    }
    ngAfterViewInit() {
        _shared_mainjs__WEBPACK_IMPORTED_MODULE_2__["mainJs"]();
    }
...
const courses = [
    {
        ...
        "requirements": {
            ...
            "requirements": [
                "Must have an interest in data science",
                "Must be an undergraduate or have completed their undergraduate education."
            ]
        },
        "price_duration": {
            "amount": "50,000.00",
    ...
    },
    {
        ...
        "jobs": {
            ...
            "jobs": [
                ...
                "Design and Code Your Own Game (Using Python & Unity)",
                "Internet Safety"
            ]
        },
        "requirements": {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mainJs", function() { return mainJs; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
function mainJs() {
    (function ($) {
        ...
        function init_scroll_navigate() {
            ...
            /*==============================================================*/
            var $window = $(window), $body = $(".bg-background-fade"), $panel = $(".color-code");
        ...
        function fullScreenHeight() {
            ...
            var sidebarNavHeight = $(".sidebar-nav-style-1").height() -
                $(".logo-holder")
                    .parent()
                    .height() -
                $(".footer-holder")
            ...
            var style2NavHeight = $(".sidebar-part2").height() -
        ...
        $(document).ready(function () {
            ...
            $(window).resize(function () {
                ...
                if (isIE()) {
                    setTimeout(function () {
                        ...
                        if ($(".swiper-slider-clients-second").length > 0 &&
                            swiperClients2) {
                            swiperClients2.update();
                        }
                        if ($(".swiper-three-slides").length > 0 && swiperThreeSlides) {
            ...
            var menuRight = document.getElementById("cbp-spmenu-s2"), showRightPush = document.getElementById("showRightPush"), body = document.body;
            if (showRightPush) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CourseDetailNavComponent", function() { return CourseDetailNavComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let CourseDetailNavComponent = class CourseDetailNavComponent {
    constructor() { }
    ngOnInit() {
    }
};
CourseDetailNavComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-course-detail-nav',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./course-detail-nav.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/ui/course-detail-nav/course-detail-nav.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./course-detail-nav.component.css */ "./src/app/ui/course-detail-nav/course-detail-nav.component.css")).default]
    })
...
/* harmony import */ var _course_detail_nav_course_detail_nav_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./course-detail-nav/course-detail-nav.component */ "./src/app/ui/course-detail-nav/course-detail-nav.component.ts");
...
module.exports = __webpack_require__(/*! /media/root/Storage/Carl Stanley/Projects/lani/lani-learning/src/main.ts */"./src/main.ts");
